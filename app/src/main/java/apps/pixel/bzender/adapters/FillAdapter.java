...
import apps.pixel.bzender.interfaces.RecyclerViewButtonClickListener;
import de.hdodenhof.circleimageview.CircleImageView;

public class FillAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements View.OnClickListener,View.OnLongClickListener {
    ...
    public FillAdapter(ArrayList<filterAreaModelRecycler> data, Context context) {
        this.dataSet = data;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NotNull ViewGroup parent, int viewType) {
        ...
        return new filterAreaAdapter.TextTypeViewHolder(view);
    ...
    public void onBindViewHolder(@NotNull final RecyclerView.ViewHolder holder, final int listPosition) {
        ...
        if (object != null)
        {
            ...
            ((filterAreaAdapter.TextTypeViewHolder) holder).CitytName.setText(object.CityName);
