package apps.pixel.bzender.Models.my_tenders;
...
public class MyTendersBody {
    ...
    private apps.pixel.bzender.Models.my_tenders.TenderElectrical TenderElectrical;
    ...
    public apps.pixel.bzender.Models.my_tenders.TenderElectrical getTenderElectrical ()
    {
        return TenderElectrical;
    }

    public void setTenderElectrical (apps.pixel.bzender.Models.my_tenders.TenderElectrical TenderElectrical)
    {
