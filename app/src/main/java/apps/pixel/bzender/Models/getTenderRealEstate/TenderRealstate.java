...
public class TenderRealstate
{
    ...
    private apps.pixel.bzender.Models.metadataCar.ActivityFor ActivityFor;
    ...
    public apps.pixel.bzender.Models.getTenderRealEstate.City getCity() {
        return City;
    }

    public void setCity(apps.pixel.bzender.Models.getTenderRealEstate.City city) {
        City = city;
    }
