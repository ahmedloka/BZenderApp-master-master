...
import apps.pixel.bzender.adapters.filterAreaAdapter;
import apps.pixel.bzender.adapters.filterAreaModelRecycler;
import apps.pixel.bzender.dialog.realEstate.DialogActivityForRealEstate;
import apps.pixel.bzender.dialog.realEstate.DialogAmenities;
import apps.pixel.bzender.dialog.realEstate.DiloagBedRoomslRealEstate;
import apps.pixel.bzender.dialog.realEstate.DiloagLevelRealEstate;

import static apps.pixel.bzender.Utills.Constant.StartDate;
import static apps.pixel.bzender.dialog.realEstate.DialogAmenities.currentSelectedItems;
        ...
        if (linearRadioBtns.getVisibility() == View.VISIBLE) {
            try {
                ...
                realEstatePresenter.addTenderWithAmin(etRangeOne.getText().toString(), etRangeTwo.getText().toString(), areaPriceOne.getText().toString(),
                        ...
                        needToForRequest, typeOfForRequest, String.valueOf(tenderId), currentSelectedItems);
                ...
                realEstatePresenter.addTenderWithoutAmin(etRangeOne.getText().toString(), etRangeTwo.getText().toString(), areaPriceOne.getText().toString(),
                        areaPriceTwo.getText().toString(), txtPeriod.getText().toString(), txtSpeceficArea.getText().toString(), etDesciption.getText().toString(),
                        licience, txtBedrooms.getText().toString(), txtLevel.getText().toString(), CityId, txtActivityFor.getText().toString(),
                        needToForRequest, typeOfForRequest, String.valueOf(tenderId));
...
//        Log.d("DATAA__", ": " + "MIN RANE " + etRangeOne.getText().toString() +
//                "MAX RANE " + etRangeTwo.getText().toString()
//                + "PRICE MIN " + areaPriceOne.getText().toString() +
//                "PRICE MAX " + areaPriceTwo.getText().toString() +
//                "PERIOD  " + txtPeriod.getText().toString() +
//                "AREA : " + txtSpeceficArea.getText().toString() + "DESC " +
//                etDesciption.getText().toString() +
//                "LICE " + licenceForSend + "BED ROOMS " +
//                txtBedrooms.getText().toString() + "LEVEL " +
//                txtLevel.getText().toString()
//                + "CITY ID " + CityId + "ACTIVITY FOR " +
//                txtActivityFor.getText().toString() +
//                "NEED TO " + needToForRequest + "TYPE OF REQ "
//                + typeOfForRequest + "TENDER ID " + (tenderId) +
