...
import static apps.pixel.bzender.activities.fillDataCar.FillDataCarActivity.btnNextCar;
import static apps.pixel.bzender.activities.fillDataElectrical.FillDataElectricalActivity.btnSend;
import static apps.pixel.bzender.activities.real_state.AddRealStateActivity.btnNextRealState;
import static apps.pixel.bzender.activities.real_state.AddRealStateActivity.mProgressBarAddTender;
...
public class AddTinderPresenter {
    ...
    private void handleResponseTender(AddTinderResponse addTinderResponse) {
        ...
        addTinderInterface.tenderAddedSuccessfully(addTinderResponse.getTenderId());
        Log.d("RESPONSE_TENDER_ID", "YOU_CLICK_ME: " + Constant.ADD_TENDER_ID + " " + addTinderResponse.toString() + " " + addTinderResponse.getTenderId());
