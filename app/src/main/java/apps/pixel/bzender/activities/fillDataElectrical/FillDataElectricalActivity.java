package apps.pixel.bzender.activities.fillDataElectrical;
...
//        listData.add("Home Appliances");
    ...
    public void tenderAddedSuccessfully(int tenderId) {
        ...
        Log.d("TenderAddedSuccessfully", "TYPE: " + type + "MODEL: " + model + "Year: " + year + "Number: " + number + "Status: " + status +
                "country: " + country + "NOTE: " + etNote.getText().toString() + "ID: " + String.valueOf(tenderId));
        fillDataElectricalPresenter.validateFillElectrical(type, model, year, number, status
                , country, etNote.getText().toString(), String.valueOf(tenderId));
    }
}
