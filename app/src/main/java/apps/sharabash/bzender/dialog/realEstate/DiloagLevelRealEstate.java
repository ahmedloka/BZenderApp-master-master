...
import apps.sharabash.bzender.adapters.realEstate.LevelAdapterRV;

import static android.content.Context.MODE_PRIVATE;

public class DiloagLevelRealEstate extends DialogFragment implements LevelAdapterRV.OnCheckChange {
    private RecyclerView mRV;
    private ButtonBold btnOk;
    private List<String> listDAta;
    private LevelAdapterRV amenitiesAdapter;
    ...
    public View onCreateView(@NotNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.dialog_level, container, true);
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        amenitiesAdapter = new LevelAdapterRV(getContext(), listDAta, this);
    ...
    public void onClick(String position) {
        AddRealStateActivity.txtLevel.setText(position);
        getDialog().dismiss();
    }
}
