...
public class TenderRealstate {
    ...
    public String toString() {
        return "ClassPojo [Description = " + Description + ", PeriodOfRenting = " + PeriodOfRenting + ", ActivityFor = " + ActivityFor + ", BedroomsCount = " + BedroomsCount + ", Tender_Id = " + Tender_Id + ", TypeOfUse = " + TypeOfUse + ", City = " + City + ", MaxSize = " + MaxSize + ", MinPrice = " + MinPrice + ", TypeOfProperty_Id = " + TypeOfProperty_Id + ", Tender = " + Tender + ", Location_Id = " + Location_Id + ", MinSize = " + MinSize + ", SpecificArea = " + SpecificArea + ", ActivityFor_Id = " + ActivityFor_Id + ", LevelInBuilding = " + LevelInBuilding + ", NeedTo_Id = " + NeedTo_Id + ", Licence = " + Licence + ", Id = " + Id + ", TypeOfProperty = " + TypeOfProperty + ", MaxPrice = " + MaxPrice + ", Amenities = " + Amenities + "]";
    }
}
