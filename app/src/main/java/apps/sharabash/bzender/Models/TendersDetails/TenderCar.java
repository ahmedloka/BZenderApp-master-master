    ...
    public String getDeductPoints ()
{
    ...
    {
        return "ClassPojo [ViolationDocument = "+ViolationDocument+", RegistrationFees = "+RegistrationFees+", EngineCapacity = "+EngineCapacity+", CrrentPoints = "+CrrentPoints+", NumberOfCar = "+NumberOfCar+", YearOfCar = "+YearOfCar+", CarModel = "+CarModel+", FromKMToKM = "+FromKMToKM+", TenderId = "+TenderId+", TransmissionType = "+TransmissionType+", CarModelId = "+CarModelId+", Note = "+Note+", LicenseStatus = "+LicenseStatus+", CarType = "+CarType+", Id = "+Id+", PossibilityOfExamination = "+PossibilityOfExamination+", CarTypeId = "+CarTypeId+", DeductPoints = "+DeductPoints+"]";
    }
}
