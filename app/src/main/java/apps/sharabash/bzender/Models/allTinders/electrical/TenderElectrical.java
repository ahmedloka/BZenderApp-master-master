    ...
    public String getNote ()
{
    ...
    {
        return "ClassPojo [Status = "+Status+", TenderId = "+TenderId+", OriginManufacturer = "+OriginManufacturer+", UnitType = "+UnitType+", Note = "+Note+", Model = "+Model+", Id = "+Id+", NumberOfUnit = "+NumberOfUnit+", YearOfManufacture = "+YearOfManufacture+"]";
    }
}
